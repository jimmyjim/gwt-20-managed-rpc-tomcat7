...
}if(a.util.trim(aL).length!==0&&aM.enableProtocol&&aM.firstMessage){var aN=aM.trackMessageLength?1:0;
...
if(a.util.trim(aS).length===0&&aJ.transport==="long-polling"){if(!aK.hasData){aM(true)
